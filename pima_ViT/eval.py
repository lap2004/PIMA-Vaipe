...
if __name__ == "__main__":
    ...
    parser.add_argument('--weights', type=str, default='model_best_vit.pth')
    args = parser.parse_args()
    
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    
    val_dataset = PimaDataset(split_file='splits/test_scenario_1-1.json', data_dir='/home/lab/son/lap/vaipepill2022/public_train', is_train=False)
    ...
    acc, correct, total = evaluate(model, val_loader, device)
    print(f"\nEvaluation Results:")
