...
class PrescriptionPill(nn.Module):
    ...
    def forward_graph(self, data, sentences_projection):
        # ABLATION 1: No GNN. Use raw sentences_projection directly.
        graph_features = sentences_projection
    ...
    def forward(self, data):
        ...
        # GRAPH (Ablation w/o GNN)
        graph_extract = self.forward_graph(data, sentences_projection)
