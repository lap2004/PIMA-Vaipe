...
def option():
    ...
    # Data Init
    parser.add_argument('--use-ocr', action='store_true', help='Use OCR text instead of cropped box images')
    parser.add_argument('--use-paddleocr', action='store_true', help='Use text extracted from PaddleOCR instead of Ground Truth')
    parser.add_argument('--data-folder', type=str, default='/home/lab/son/lap/vaipe_pima_format/')
