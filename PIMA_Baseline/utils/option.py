...
def option():
    ...
    # Inference
    parser.add_argument('--inference-folder', type=str, default="data_inference/data/pres/")
    parser.add_argument('--model-path', type=str, default="logs/saved/model_best.pth")
